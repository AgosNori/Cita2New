...
function NavBorde() {
    return (
        <div className="button-container">
            <button className="button home" data-title="Home">
            ...
            <button className="button search" data-title="Search">
            ...
            <button className="button profile" data-title="Profile">
            ...
            <button className="button cart" data-title="Cart">
