...
function NavBorde() {
    return (
        <div className="button-container">
            ...
            <Link to="/search" className="button search" data-title="Search">
            ...
            <Link to="/profile" className="button profile" data-title="Profile">
            ...
            <Link to="/cart" className="button cart" data-title="Cart">
